        ...
        child: ListView(
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: mealTypes.map((meal) => DropdownMenuItem(value: meal, child: Text(meal))).toList(),
              onChanged: (val) => setState(() => selectedMealType = val),
              hint: const Text('식사 종류를 선택해주세요'),
            ),
            const SizedBox(height: 16),
            DropdownButtonFormField<int>(
              ...
              items: maxParticipantsOptions
                  .map((count) => DropdownMenuItem(value: count, child: Text('$count명')))
                  .toList(),
              onChanged: (val) => setState(() => _selectedMaxParticipants = val ?? 2),
              hint: const Text('모집인원을 선택해주세요'),
            ),
            const SizedBox(height: 16),
            const Divider(),
            ...
            if (selectedGeoPoint != null)
              Padding(
                ...
                child: Text(
                  '위치 좌표: ${selectedGeoPoint!.latitude}, ${selectedGeoPoint!.longitude}',
