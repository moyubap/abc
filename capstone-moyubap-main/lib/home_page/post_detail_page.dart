                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(intro, style: const TextStyle(color: Colors.grey, fontSize: 12)),
                                  ],
                                ),
                              ],
                            ),
                      ...
                      const Text('관심 3 ∙ 조회 360', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                      const SizedBox(height: 12),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: const [
                            ...
                            SizedBox(width: 8),
                            Text('지원자 6명', style: TextStyle(color: Colors.black87, fontSize: 15)),
                          ],
                        ),
                      ),
                      const SizedBox(height: 24),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  const Text('관심', style: TextStyle(color: Colors.black)),
                  const Spacer(),
                  ElevatedButton.icon(
                    onPressed: () async {
