  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('지도', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: SafeArea(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('모집 내용: ${post.content}', maxLines: 2, overflow: TextOverflow.ellipsis),
            const Spacer(),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('음식: ${post.foodType}', style: const TextStyle(fontSize: 15)),
